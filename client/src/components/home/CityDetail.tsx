...
const CityDetail = ({ city, onCreatePlan }: CityDetailProps) => {
  return (
    <div className="w-full flex flex-col">
      <div className="mb-18 flex">
          ...
          <div className="flex gap-x-26 mb-16">
            <div className="flex flex-col">
              <div className="mb-16 flex">
                <FlightIcon />
                <span className="ml-8 text-15 tracking-[0.15px] font-semibold">항공</span>
              </div>
              <div className="text-14 tracking-[0.14px]">
                <p className="text-gray600 mb-8">직항</p>
                <p className="text-gray800 font-medium">약 {city.flightHours}시간</p>
              </div>
            </div>
            <div className="flex flex-col">
              <div className="mb-16 flex">
                <VisaIcon />
                <span className="ml-8 text-15 tracking-[0.15px] font-semibold">비자</span>
              </div>
              <div className="text-14 tracking-[0.14px]">
                <p className="text-gray600 mb-8">
                  {city.country.visa.required ? '필요' : '무비자'}
                </p>
                <p className="text-gray800 font-medium">{city.country.visa.duration}일</p>
              </div>
            </div>
            <div className="flex flex-col">
              <div className="mb-16 flex">
                <VoltageIcon />
                <span className="ml-8 text-15 tracking-[0.15px] font-semibold">전압</span>
              </div>
              <div className="text-14 tracking-[0.14px]">
                <p className="text-gray600 mb-8">콘센트</p>
                <p className="text-gray800 font-medium">{city.country.voltage}V</p>
              </div>
            </div>
            <div className="flex flex-col">
              <div className="mb-16 flex">
                <ClockIcon />
                <span className="ml-8 text-15 tracking-[0.15px] font-semibold">시차</span>
              </div>
              <div className="text-14 tracking-[0.14px]">
        ...
        <img src={city.thumbnail} alt={city.name} className="w-[260px] rounded-10 ml-17" />
      </div>
      <Button className="w-185" onClick={onCreatePlan}>
